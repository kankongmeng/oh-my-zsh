...
alias inp='adb shell input text'

alias gjf='google-java-format'
alias gjff='google-java-format -i --aosp'
alias lc='adb shell input text 5264714450037326'
alias lg='adb shell input tap 925 450 && adb shell input tap 110 675 && adb shell input text spdqaacct+nccmech2@gmail.com && adb shell input keyevent 61 && adb shell input text Awesome2 && adb shell input tap 800 1120'
